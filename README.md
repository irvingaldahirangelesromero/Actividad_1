<div style="display: flex; justify-content: space-around; margin-bottom: 20px; border: 1px solid #ccc; padding: 10px;">
  <img src="src/captura(1.1).png" alt="Texto alternativo 1" width="333">
  <img src="src/captura(2.1).png" alt="Texto alternativo 2" width="333">
  <img src="src/captura(3.1).png" alt="Texto alternativo 3" width="333">
</div>
<div style="display: flex; justify-content: space-around; margin-bottom: 20px; border: 1px solid #ccc; padding: 10px;">
